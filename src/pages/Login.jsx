...
export function Login() {
  ...
  return (
    <div className={`min-h-screen flex flex-col bg-white transition-opacity duration-500 ${
      ...
      <nav className="flex items-center justify-center relative px-4 lg:px-20 py-5 bg-white">
        ...
        <div className="absolute right-4 lg:right-8 flex items-center gap-4">
          <Link to="/signup" className="text-[oklch(20.8%_0.042_265.755)] hover:text-green-700 font-medium">
            Sign up
          </Link>
        </div>
      </nav>
          ...
          <div className="text-center mb-8">
           ...
           <form onSubmit={handleSubmit} className="space-y-4 flex flex-col items-center">
            ...
            <p className="text-xs text-gray-500 w-[400px] text-[oklch(20.8%_0.042_265.755)]">
              ...
              <Link to="#" className="text-[oklch(20.8%_0.042_265.755)]   underline hover:no-underline">Forgot password?</Link>
           ...
           <div className="text-center mt-6">
            <Link to="/signup" className="text-[oklch(20.8%_0.042_265.755)] hover:text-green-700 font-medium text-sm">
